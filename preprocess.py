...
parser.add_argument('--clip_duie',action='store_true')
...
def create_cliped_file(fp):
    ...
    for line in lines:
        ...
        # elif line_split[1][0].lower() == 'e' and now_example_len>200:
        #     print('',file=f_out)
        #     now_example_len = 0
...
if args.clip_duie:
    create_cliped_file('./data/DuIENER/train_dev.char.bio')
    create_cliped_file('./data/DuIENER/test.char.bio')
