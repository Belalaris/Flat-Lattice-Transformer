...
parser.add_argument('--dataset', default='ontonotes', help='weibo|resume|ontonotes|msra|clue|duie')
...
#                                                     )
    ...
    datasets,vocabs,embeddings = load_duie_ner(duie_ner_path,yangjie_rich_pretrain_unigram_path,yangjie_rich_pretrain_bigram_path,
                                                    _refresh=refresh_data,index_token=False, train_clip=args.train_clip,
                                                    _cache_fp=raw_dataset_cache_name,
                                                    char_min_freq=args.char_min_freq,
                                                    bigram_min_freq=args.bigram_min_freq,
...
if args.model == 'transformer':
    if args.lattice:
        if args.use_bert:
            bert_embedding = BertEmbedding(vocabs['lattice'],model_dir_or_name='../bert-chinese-wwm',
...
if args.dataset == 'msra' or 'clue' or 'duie':
...
saver = ModelSaver("../model/{}.pkl".format(args.dataset + '_V1_' + now_time))
